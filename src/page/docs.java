...
public class docs {
	...
	public docs() {
		...
		buttonDownload = TestCaseCommon.getDriver().findElement(By.linkText("Checklist Técnico"));
		buttonDocUser = TestCaseCommon.getDriver().findElement(By.linkText("Documentação do Usuário"));
